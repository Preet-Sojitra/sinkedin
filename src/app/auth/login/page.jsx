        ...
        <div className="max-w-md">
          ...
          >
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold mb-2 text-accent">Ready for More Shenanigans?</h3>
                <p className="text-sm leading-relaxed text-light">
                  Time to dive back into today's collection of cringe, commiseration, and career
                  cautionary tales. Your daily dose of 'it could be worse' awaits.
                </p>
              </div>
            </div>
          </div>
          <div className="space-y-3">
            ...
            <div className="flex items-center text-light">
              <div className="w-2 h-2 rounded-full mr-3 bg-accent"></div>
              <span className="text-sm">
                Find your people - the ones who also hit 'Reply All' on that email.
              </span>
            </div>
            <div className="flex items-center text-light">
              <div className="w-2 h-2 rounded-full mr-3 bg-accent"></div>
              <span className="text-sm">
                Your daily reminder that someone, somewhere, is failing harder than you
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="lg:hidden text-center mb-8">
            ...
            <p className="mt-1 text-light-secondary">Welcome back to the chaos</p>
          </div>
          ...
          <div className="rounded-lg border p-8 bg-dark-secondary border-[color:var(--accent)]/30">
            ...
            <div className="flex items-center mb-6">
              <div className="flex-grow border-t border-[color:var(--accent)]/30"></div>
              <span className="px-4 text-sm text-light-secondary">or</span>
              <div className="flex-grow border-t border-[color:var(--accent)]/30"></div>
            </div>{" "}
            {showError && (
              <div className="mb-2 text-sm text-red-500 text-center">{errorMessage}</div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium mb-2 text-light">
                  Password
                </label>
            ...
            <div className="mt-6 p-3 rounded-lg flex items-start bg-dark">
              ...
              <p className="text-xs text-light-secondary">
                By logging in, you acknowledge that your career is probably still a mess, and that's
                totally fine here.
              </p>
            </div>
          </div>
