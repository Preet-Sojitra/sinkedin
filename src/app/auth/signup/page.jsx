        ...
        <div className="max-w-md">
          ...
          <div className="bg-[color:var(--accent)/0.12] border border-[color:var(--accent)/0.24] rounded-lg p-6 mb-8">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-red-400 font-semibold mb-2">Fair Warning</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  This is a space for sharing your job market fails in a humorous way. Expect snark,
                  memes, and a lot of roasting. If you can't handle brutal honesty about career
                  disasters, this isn't the place for you.
                </p>
              </div>
            </div>
          </div>
