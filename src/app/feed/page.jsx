...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const loadPosts = async () => {
      ...
      const { posts: newPosts = [], hasMore: newHasMore = false } = (await fetchPosts(page)) || {};
  ...
  return (
    <main className="max-w-[800px] mx-auto my-5 px-5 md:my-6 md:px-6 flex flex-col gap-5 md:gap-6">
      ...
      {!hasMore && !isLoading && (
        <p className="text-center text-light-secondary mt-2 mb-4 text-sm">
